...
function CreateNewAccountButton() {
  return (
    <div className="border-t border-gray-300 mt-6 pt-6 text-center">
      <Link
        to="/signup"
        className="w-full py-2 px-4 bg-primary text-white font-semibold rounded hover:bg-primaryHover transition duration-300"
      >
        Create New Account
      </Link>
    </div>
...
function OAuthButtons() {
  return (
    <div className="text-center">
      ...
      <button
        type="button"
        className="w-full py-2 px-4 border-2 font-semibold rounded hover:bg-primaryHover transition duration-300"
      >
        <FontAwesomeIcon icon={faGoogle}
          style={{ color: 'red' }} // Apply a custom color
  ...
  return (
    <div className="bg-gray-100 h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-semibold text-gray-800 mb-6">Login to <span className="text-secondary">AmraLate</span></h2>
